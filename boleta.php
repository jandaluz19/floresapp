    ...
    <div class="boleta">
        <div class="header">
            ...
            <div class="empresa-info">
                RUC: 20123456789<br>
                Av. Las Flores 123, Puno - Perú<br>
                Tel: (01) 234-5678 | Email: ventas@floresonlineunap.com
            </div>
            <div class="boleta-tipo">BOLETA DE VENTA ELECTRÓNICA</div>
        </div>
        ...
        <div class="footer">
            ...
            <p>Puede verificar el documento en: www.floresonlineunap.com/verificar</p>
