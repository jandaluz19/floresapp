<footer style="background: #333; color: white; text-align: center; padding: 2rem; margin-top: 4rem;">
    <div style="margin-bottom: 1.5rem;">
        <h3 style="margin-bottom: 1rem; color: white;">Síguenos en Redes Sociales</h3>
        <div style="display: flex; gap: 2rem; justify-content: center; align-items: center; flex-wrap: wrap;">
            <!-- Facebook -->
            <a href="https://www.facebook.com/BellaFloraPerú" target="_blank" 
               style="color: white; text-decoration: none; display: flex; flex-direction: column; align-items: center; transition: transform 0.3s;" 
               ...
               onmouseout="this.style.transform='scale(1)'">
                ...
                <span style="font-size: 0.85rem; margin-top: 0.5rem;">Facebook</span>
            </a>
            
            <!-- WhatsApp -->
            <a href="https://wa.me/51987654321?text=Hola,%20me%20interesa%20comprar%20flores%20🌸" target="_blank" 
               style="color: white; text-decoration: none; display: flex; flex-direction: column; align-items: center; transition: transform 0.3s;" 
               onmouseover="this.style.transform='scale(1.15)'" 
               onmouseout="this.style.transform='scale(1)'">
                ...
                <span style="font-size: 0.85rem; margin-top: 0.5rem;">WhatsApp</span>
            </a>
            
            <!-- Instagram -->
            <a href="https://www.instagram.com/BellaFloraPerú" target="_blank" 
               style="color: white; text-decoration: none; display: flex; flex-direction: column; align-items: center; transition: transform 0.3s;" 
               onmouseover="this.style.transform='scale(1.15)'" 
               onmouseout="this.style.transform='scale(1)'">
                ...
                <span style="font-size: 0.85rem; margin-top: 0.5rem;">Instagram</span>
            </a>
            
            <!-- TikTok -->
            <a href="https://www.tiktok.com/@BellaFloraPerú" target="_blank" 
               style="color: white; text-decoration: none; display: flex; flex-direction: column; align-items: center; transition: transform 0.3s;" 
               onmouseover="this.style.transform='scale(1.15)'" 
               onmouseout="this.style.transform='scale(1)'">
                ...
                <span style="font-size: 0.85rem; margin-top: 0.5rem;">TikTok</span>
            </a>
        </div>
    </div>
    ...
    <div style="border-top: 1px solid rgba(255,255,255,0.2); padding-top: 1.5rem; margin-top: 1.5rem;">
        <p style="margin: 0.5rem 0; font-size: 1rem;">
            <strong>🌸 Flores online unap</strong>
        </p>
        <p style="margin: 0.5rem 0; color: #ccc;">
            📍 Av. Las Flores 123, Puno - Perú
        </p>
        <p style="margin: 0.5rem 0; color: #ccc;">
            📞 (01) 234-5678 | 📱 901 400 564
        </p>
        <p style="margin: 0.5rem 0; color: #ccc;">
            📧 ventas@floresonlineunap.com
        </p>
        <p style="margin-top: 1.5rem; color: #999; font-size: 0.9rem;">
            &copy; <?php echo date('Y'); ?> Flores online unap - derechos reservados
        </p>
    </div>
</footer>

<!-- Botón flotante de WhatsApp -->
<a href="https://wa.me/51987654321?text=Hola,%20me%20interesa%20comprar%20flores%20🌸" 
   target="_blank" 
